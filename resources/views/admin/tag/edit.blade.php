                ...
                <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Your new <b>Tags</b> has been created. Invite your
                            team to collaborate on this project.
                        </p>

                        <form class="mt-4" action="{{ route('tag.update', $tag->id) }}" method="POST"
                            ...
                            <label class="form-label block mt-3">
                                <input type="text" name="name" id="name" placeholder="Input Tag Name" value="{{$tag->name}}"
                            ...
                            <label class="block mt-3">
                                <input type="text" name="slug" id="slug" placeholder="Input Slug Name" value="{{$tag->slug}}"
                            ...
                            <div class="mt-4 sm:flex sm:items-center sm:-mx-2">
                                <a href="{{url('tag')}}"><button type="button" @click="isOpen = false"
