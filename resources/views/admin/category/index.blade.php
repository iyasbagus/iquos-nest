...
<body class="font-sans antialiased>
    <div class="min-h-screen bg-gray-100" x-data="{ isOpen: { add: false, show: false, selectedId: null }, loading: false }">
                                        ...
                                        @foreach ($category as $item)
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <button
                                                            class="inline-flex items-center rounded-md bg-indigo-50 px-2 py-1 mr-4 text-xs font-medium text-indigo-600 ring-1 ring-indigo-500/10 ring-inset"><a
                                                                href="{{ route('category.edit', $item->id) }}">Edit</a></button>
                                                        <button
                                                            @click.prevent="isOpen.show = true; isOpen.selectedId = {{ $item->id }}"
    ...
    {{-- Modal Add Data --}}
    <div x-show="isOpen.add" x-transition:enter="transition duration-300 ease-out" x-cloak
            ...
            <div
                ...
                <form class="mt-4" action="{{ route('category.store') }}" method="POST"
                    ...
                    <label class="block mt-3">
                        <input type="text" name="slug" id="slug" placeholder="Input Slug Name"
                    ...
                    <div class="mt-4 sm:flex sm:items-center sm:-mx-2">
                        <button type="button" @click="isOpen.add = false"
    ...
    @foreach ($category as $cat)
        <div x-show="isOpen.show && isOpen.selectedId === {{ $cat->id }}" x-cloak
            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <form action="{{ route('category.store') }}" method="POST" @submit.prevent>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-center mx-auto">
                            <img class="h-full rounded-lg" src="{{ asset('admin/images/category/' . $cat->images) }}"
                                alt="" />
                        </div>
                        ...
                        <div class="mt-4 sm:flex sm:items-center sm:justify-between sm:mt-6 sm:-mx-2">
                            <button @click="isOpen.show = false; isOpen.selectedId = null"
